...
export class Documentation {
  ...
  static manualRunMenuSysDocRun() {
    ...
    Documentation.commandbox._getRunParams(tgtType, target, docCommand).then(response => {
      Documentation.commandbox._onRunReturn(response.return[0], dummyCommand);
    }, response => {
      Documentation.commandbox._onRunReturn("DOCUMENTATION ERROR:\n\n" + JSON.stringify(response), dummyCommand);
    });
  }
  ...
  static manualRunMenuHtmlDocRun(menuitem) {
    ...
    // level 0
    html += "<p><a href='" + Documentation.DOCUMENTATION_URL + "' target='_blank'>Salt Module Reference" + Documentation.EXTERNAL_LINK + "</a></p>";
    ...
    html += "<p><a href='" + Documentation.DOCUMENTATION_URL + cmd[0] + "/all/index.html' target='_blank'>" + pageTitle + Documentation.EXTERNAL_LINK + "</a></p>";
    ...
    for(const m of concreteModules) {
      ...
      // level 2
      if(cmd.length >= 2)
        html += "<p><a href='" + Documentation.DOCUMENTATION_URL + cmd[0] + "/all/salt." + cmd[0] + "." + m + ".html' target='_blank'>Module '" + (cmd[0] + "." + m).replace(/^modules[.]/, "") + "'" + Documentation.EXTERNAL_LINK + "</a></p>";

      // level 3
      if(cmd.length >= 3)
        html += "<p>" + indent + "<a href='" + Documentation.DOCUMENTATION_URL + cmd[0] + "/all/salt." + cmd[0] + "." + m + ".html#salt." + cmd[0] + "." + m + "." + cmd[2] + "' target='_blank'>Function '" + (cmd[0] + "." + m + "." + cmd[2]).replace(/^modules[.]/, "") + "'" + Documentation.EXTERNAL_LINK + "</a></p>";
    }
    ...
    if(cmd.length >= 2 && cmd[0] === "modules" && knownVirtualModules.indexOf(cmd[1]) >= 0) {
      ...
      html += "<p><a href='" + Documentation.DOCUMENTATION_URL + cmd[0] + "/all/salt." + cmd[0] + "." + cmd[1] + ".html' target='_blank'>'" + cmd[0] + "." + cmd[1] + "' modules" + Documentation.EXTERNAL_LINK + "</a></p>";
    }
    ...
    if(cmd.length >= 2 && cmd[0] === "modules" && cmd[1] === "grains") {
      ...
      html += "<p><a href='" + Documentation.DOCUMENTATION_URL + "grains/all/index.html' target='_blank'>Grains Modules" + Documentation.EXTERNAL_LINK + "</a></p>";
    }
    ...
    if(cmd.length >= 2 && cmd[0] === "modules" && cmd[1] === "pillar") {
      ...
      html += "<p><a href='" + Documentation.DOCUMENTATION_URL + "pillar/all/index.html' target='_blank'>Pillar Modules" + Documentation.EXTERNAL_LINK + "</a></p>";
    }
    ...
    if(cmd.length >= 2 && cmd[0] === "modules" && cmd[1] === "state") {
      ...
      html += "<p><a href='" + Documentation.DOCUMENTATION_URL + "states/all/index.html' target='_blank'>State Modules" + Documentation.EXTERNAL_LINK + "</a></p>";
    }
    ...
    if(cmd.length >= 2 && cmd[0] === "modules" && cmd[1] === "cloud") {
      ...
      html += "<p><a href='" + Documentation.DOCUMENTATION_URL + "clouds/all/index.html' target='_blank'>Cloud Modules" + Documentation.EXTERNAL_LINK + "</a></p>";
    }
    ...
    if(cmd.length >= 2 && cmd[0] === "modules" && cmd[1] === "beacons") {
      ...
      html += "<p><a href='" + Documentation.DOCUMENTATION_URL + "beacons/all/index.html' target='_blank'>Beacon Modules" + Documentation.EXTERNAL_LINK + "</a></p>";
    }
